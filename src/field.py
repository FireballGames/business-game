...
class Field:
    ...
    def __init__(self, logos):
        ...
        self.tiles = [
            ...
            Tile(1, "Руссо-Балтъ", 9000, 50,
                group=groups.automotive_group, logo=car_factory_logo,
                position=(1, 0)),
            Tile(2, "Ньюпортъ", 20000, 50, position=(2, 0)),
            Tile(3, "Доходный домъ", 9000, 30,
                group=groups.hotel_group, logo=hotel_logo,
                position=(3, 0)),
            Tile(4, "Рулѣтка", 0, tile_type="casino", position=(4, 0)),  # Казино
            Tile(5, "Гарфункѣль", 10000, 50, position=(5, 0)),
            Tile(6, "Елѣсѣѣвъ", 2000, 20,
                group=groups.grocery_group, position=(6, 0)),
            Tile(7, "Філіповъ", 1500, 20,
                group=groups.grocery_group, position=(7, 0)),
            Tile(8, "Табакь", 1000, 50, position=(8, 0)),
            Tile(9, "Трактіръ", 5000, 20,
                group=groups.grocery_group, position=(9, 0)),
            Tile(10, "Квасъ", 7000, 20,
                group=groups.grocery_group, position=(10, 0)),

            Tile(11, "Околотокъ", 10000, tile_type="jail",
                position=(10, 1)),  # Тюрьма

            Tile(12, "Зінгѣръ", 3000, 0, position=(10, 2)),
            Tile(13, "Сбітѣнь", 7000, 15,
                group=groups.grocery_group, position=(9, 2)),
            Tile(14, "Извозъ", 2000, 0,
                group=groups.automotive_group, position=(8, 2)),
            ...
            Tile(18, "Махорка", 5000, 15, position=(4, 2)),
            Tile(19, "Фордъ", 8000, 0,
                group=groups.automotive_group, tile_type="event",
                position=(3, 2)),  # Событие
            Tile(20, "Голландъ-Голландъ", 2000, 20, position=(2, 2)),
            Tile(21, "Рулѣтка", 0, 0, tile_type="casino", position=(1, 2)),
            Tile(22, "Бобровъ и Ко", 2000, 15, position=(0, 2)),

            Tile(23, "Околотокъ", 8000, 0, tile_type="jail", position=(0, 3)),

            Tile(24, "Крупъ", 50000, 50, position=(0, 4)),
            Tile(25, "Савой", 15000, 30,
                group=groups.hotel_group, logo=hotel_logo,
                position=(1, 4)),
            Tile(26, "Остінъ", 10000, 50,
                group=groups.automotive_group, logo=car_factory_logo,
                position=(2, 4)),
            Tile(27, "Сытінъ", 3000, 20, group=groups.grocery_group, position=(3, 4)),
            ...
            Tile(34, "Медъ", 7000, 20, group=groups.grocery_group, position=(10, 4)),

            Tile(35, "Околотокъ", 0, 0, tile_type="jail", position=(10, 5)),  # Тюрьма

            Tile(36, "Асторія", 2000, 30,
                group=groups.hotel_group, logo=hotel_logo, position=(10, 6)),
            Tile(37, "Банкъ", 2000, tile_type="bank", position=(9, 6)),
            Tile(38, "Яхта", 3000, 15, position=(8, 6)),  # Обычная клетка предприятия
            Tile(39, "Кофій", 4000, 15,
                group=groups.grocery_group, position=(7, 6)),
            ...
            Tile(44, "Бѣнтли", 10000, 0,
                group=groups.automotive_group, tile_type="event", position=(2, 6)),  # Событие
            Tile(45, "Чай", 7000, 15,
                group=groups.grocery_group, position=(1, 6)),  # Обычная клетка предприятия
    ...
    def update(self, event):
        ...
        if event.type == pygame.MOUSEMOTION:
            if self.dragging:
                dx = event.pos[0] - self.start_drag_pos[0]
                dy = event.pos[1] - self.start_drag_pos[1]
                self.offset_x += dx
                self.offset_y += dy
                self.start_drag_pos = event.pos
    ...
    def draw(self, screen, players):
        """Draw field on surface.

        Args:
            screen (pygame.Surface): Surface to draw field.
